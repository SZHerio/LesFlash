...
- один визуальный язык для 1970-х и более поздних десятилетий;
...
Screen 1 — main menu: exact title "БОМЖАРА"; subdued illustrated background of a worn fictional-city railway overpass and bus stop, visually compatible with the 1970s but not tied to a real country; buttons "ПРОДОЛЖИТЬ", "НОВАЯ ЖИЗНЬ", "ХРОНИКИ", "НАСТРОЙКИ"; small autosave indicator.
Screen 2 — city: header "ДЕНЬ 1 · 08:20", age "18", money "0"; state indicators "ЗДОРОВЬЕ", "ГОЛОД", "ЭНЕРГИЯ", "НАПРЯЖЕНИЕ", "МОРАЛЬ"; map "СТАРЫЙ ВОКЗАЛ" with a player dot, route and location markers; navigation "ГОРОД", "ГЕРОЙ", "РЮКЗАК", "ЛЮДИ", "ДЕЛА".
...
Constraints: Russian UI text only; no real-country currency; no logos, trademarks, watermark, neon, fantasy, cyberpunk, candy gradients, excessive gloss, tiny clutter, or imitation of the old reference game's skin; Android-friendly spacing and accessibility.
```
...
Screen 3 — later-life mission: header "17 МАЯ 1991 · 14:35", age "35"; title "ВЫЗОВ: ДТП"; urban accident without gore; cards "ПОСТРАДАВШИЙ 1", "ПОСТРАДАВШИЙ 2", "ПОСТРАДАВШИЙ 3"; supply counters; buttons "ОСМОТРЕТЬ", "СТАБИЛИЗИРОВАТЬ", "ТРАНСПОРТИРОВАТЬ".

Constraints: Russian UI only; no real-country currency, logos, trademarks, watermark, gore, neon, cyberpunk, mascots, glossy toy UI, modern smartphone metaphor or excessive clutter; accessible button sizes and strong contrast.
```
